      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            ...
            "Custom API infrastructure — connect any ERP, POS, legacy system, or internal platform at any scale",
            { section: "── AI & AUTOMATION ──" },
            "Multiple AI voice agents — dedicated inbound and outbound agents per campaign, team, or location",
            "Custom AI pipelines — data processing, lead scoring, and routing built for your volume and logic",
      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            ...
            "Infraestructura de API personalizada — conecta cualquier ERP, POS, sistema legado o plataforma interna a cualquier escala",
            { section: "── AI & AUTOMATIZACIÓN ──" },
            "Múltiples agentes de voz con AI — agentes de entrada y salida dedicados por campaña, equipo o ubicación",
            "Pipelines de AI personalizados — procesamiento de datos, calificación de leads y enrutamiento construido para tu volumen y lógica",
