      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            ...
            "Essential Dashboard — included at no extra cost. Live KPIs: revenue, appointments, follow-ups, show rate, and no-shows on one screen, branded to your business",
        ...
        },
        {
          ...
          features: [
            ...
            { section: "── FULL COMMAND CENTER ──" },
            "Full Command Center — custom-built dashboard with real-time KPIs, closer rankings, pipeline funnel, historical comparisons, role-based views (owner vs manager), and unlimited integrations. Setup included.",
            ...
            "Multi-location CRM architecture — manage all your locations and teams from a single Command Center",
      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            ...
            { section: "── COMMAND CENTER ──" },
            "Dashboard Esencial — incluido sin costo adicional. KPIs en tiempo real: ingresos, citas, seguimientos pendientes, tasa de asistencia y no-shows en una sola pantalla, con tu marca",
        ...
        },
        {
          ...
          features: [
            ...
            { section: "── COMMAND CENTER COMPLETO ──" },
            "Command Center Completo — dashboard construido a medida con KPIs en tiempo real, rankings de closers, embudo de pipeline, comparaciones históricas, vistas por rol (dueño vs. gerente) e integraciones ilimitadas. Setup incluido.",
            ...
            "Arquitectura de CRM multi-ubicación — gestiona todas tus sucursales y equipos desde un solo Command Center",
