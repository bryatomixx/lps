      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            ...
            "Basic Dashboard — included at no extra cost. Live KPIs: revenue, appointments, follow-ups, show rate, and no-shows on one screen, branded to your business",
      ...
      plans: [
        ...
        },
        {
          ...
          features: [
            ...
            { section: "── COMMAND CENTER ──" },
            "Dashboard Básico — incluido sin costo adicional. KPIs en tiempo real: ingresos, citas, seguimientos pendientes, tasa de asistencia y no-shows en una sola pantalla, con tu marca",
