...
const industries = [
  ...
  "Dental / Salud",
  "Med Spa / Estética",
  "Contratista / Servicios del Hogar",
          ...
          {status === "success" ? (
            ...
            >
              ...
              <p style={{ color: "var(--text-muted)", fontSize: "0.9rem" }}>
                Tu plan de automatización personalizado está siendo preparado. Nos pondremos en contacto contigo en las próximas 24 horas.
              </p>
            </motion.div>
          ) : (
            <>
              ...
              >
                Dinos tu nombre y correo. Te enviaremos un análisis personalizado
                de exactamente qué automatizaciones tendrían el mayor impacto en
                tu negocio específico — sin llamada de ventas requerida.
              </p>
              ...
              >
                ...
                >
                  <option value="" disabled>Tu industria</option>
                  {industries.map((ind) => (
                ...
                >
                  {status === "sending" ? "Enviando..." : "Enviar Mi Plan Gratis →"}
                </button>
              </form>
              ...
              >
                Sin spam. Sin presión de ventas. Solo una estrategia de automatización real para tu negocio.
              </p>
            </>
          )}
        </div>
