...
const tickerItems = [
  "Tu teléfono, atendido 24/7",
  "Seguimientos en piloto automático",
...
const proofChips = [
  "Llamadas atendidas automáticamente",
  "Leads seguidos en segundos",
  "Tareas corriendo mientras duermes",
];
      ...
      >
        ...
        <div
          style={{
            ...
            maxWidth: 600,
            maxHeight: 600,
            background: "radial-gradient(circle, rgba(200,148,26,0.10) 0%, transparent 70%)",
            pointerEvents: "none",
            filter: "blur(50px)",
        ...
        >
          ...
          <div>
            ...
            >
              ...
              />
              <DecryptedText
                text="Automatización IA lista para tu negocio"
                animateOn="view"
                sequential={true}
                speed={30}
            ...
            >
              {["Deja de Operar", "tu Negocio.", "Empieza a Hacerlo Crecer."].map((line, li) => (
                <motion.span
                  key={li}
            ...
            >
              {proofChips.map((chip, i) => (
                ...
                >
                  ...
                  <span style={{ fontFamily: "'DM Mono', monospace", fontSize: "0.62rem", letterSpacing: "0.1em", color: "var(--text-muted)" }}>
                    {chip}
                  </span>
                </motion.div>
              ))}
            ...
            >
              <div style={{ display: "flex", gap: 14, flexWrap: "wrap", alignItems: "center" }}>
                ...
                >
                  Muéstrame Mi Plan de Automatización
              ...
              >
                🛡️ Garantía de ROI 90 días — resultados o trabajamos gratis
              </motion.span>
            </motion.div>
          </div>
          ...
          >
            ...
            <div style={{ position: "relative", animation: "float 6s ease-in-out infinite" }}>
              <Image
                ...
                alt="Asistente de automatización IA de Latin Prime Systems — representa operaciones empresariales automatizadas 24/7"
                width={520}
                height={520}
                style={{
                  width: "100%",
