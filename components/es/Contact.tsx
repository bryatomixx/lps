    ...
    >
      <div className="section-inner">
        ...
        >
          {/* Izquierda */}
          <SectionReveal>
            <div className="slabel">Contáctanos</div>
            <h2
            ...
            >
              Cuéntanos sobre tu negocio. Te responderemos en menos de 24 horas
              con un plan de automatización personalizado — sin discurso de ventas,
              solo una estrategia real para tu situación específica.
            </p>
              ...
              >
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <textarea
                    ...
                    placeholder="Cuéntanos sobre tu principal cuello de botella operativo o qué te impide crecer..."
                    style={{
                      width: "100%",
                      background: "var(--surface)",
                      border: "1px solid var(--border2)",
                ...
                >
                  {status === "idle" && "Enviar — Te respondemos en menos de 24 horas"}
                  {status === "sending" && "Enviando..."}
                  {status === "success" && "✓ Enviado — Nos pondremos en contacto pronto"}
                  {status === "error" && "Error — Por favor intenta de nuevo"}
                </button>
              </div>
            </form>
          </SectionReveal>
