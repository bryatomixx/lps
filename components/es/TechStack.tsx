  ...
  return (
    ...
    >
      <div className="section-inner">
        <SectionReveal>
          <div className="slabel">Bajo el Capó</div>
          <h2
            className="section-title"
            style={{ fontSize: "clamp(2rem, 3.5vw, 3rem)", maxWidth: 640 }}
          >
            Las Plataformas Más Potentes{" "}
            <em
              style={{
                fontStyle: "italic",
          ...
          <p className="section-desc">
            Detrás de cada resultado que entregamos hay una selección cuidadosa de
            las plataformas empresariales más potentes del mercado — conectadas y
            configuradas por nuestro equipo para que nunca tengas que preocuparte por ellas.
          </p>
        </SectionReveal>
        ...
        <SectionReveal delay={0.1}>
          ...
          >
            Las mismas plataformas usadas por empresas globales — configuradas para tu negocio
          </div>
        </SectionReveal>
      </div>
