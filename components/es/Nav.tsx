    ...
    <>
      <motion.nav
        ...
        style={{
          ...
          background: scrolled ? "rgba(2,5,8,0.92)" : "transparent",
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          >
            <span style={{ display: "block", width: 18, height: 1.5, background: "var(--text)", transition: "all 0.3s", transform: menuOpen ? "rotate(45deg) translate(5px, 5px)" : "none" }} />
            <span style={{ display: "block", width: 18, height: 1.5, background: "var(--text)", transition: "all 0.3s", opacity: menuOpen ? 0 : 1 }} />
            <span style={{ display: "block", width: 18, height: 1.5, background: "var(--text)", transition: "all 0.3s", transform: menuOpen ? "rotate(-45deg) translate(5px, -5px)" : "none" }} />
          </button>
        </div>
      </motion.nav>
