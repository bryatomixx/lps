  ...
  return (
    ...
    >
      ...
      <div className="section-inner" style={{ position: "relative", zIndex: 1 }}>
        <SectionReveal>
          <div className="slabel">Calculadora de ROI</div>
          <h2
          ...
          <p className="section-desc">
            Ajusta los controles según tu negocio. Descubre exactamente cuánto vale
            la automatización para tu situación específica.
          </p>
        </SectionReveal>
        ...
        >
          ...
          >
            ...
            <SliderInput
              ...
              step={1}
              onChange={setCalls}
              display={`${calls} llamadas`}
              tooltip="Cuántas llamadas quedan sin respuesta en una semana típica"
            />
            <SliderInput
            ...
            />
            <SliderInput
              label="Tu tasa de cierre estimada"
              value={closeRate}
              min={5}
              max={80}
              step={5}
              ...
              display={`${closeRate}%`}
              tooltip="Porcentaje de prospectos calificados que normalmente cierras"
            />
            <SliderInput
              label="Horas/semana en administración manual"
              value={hoursPerWeek}
              min={1}
              max={40}
              step={1}
              ...
              tooltip="Tiempo dedicado a seguimientos, captura de datos, agenda y reportes"
            />
            <SliderInput
              label="Valor de tu tiempo"
              value={hourlyRate}
              min={25}
              max={500}
              step={25}
              ...
              tooltip="Cuánto vale una hora de tu tiempo para el negocio"
            />
            ...
            >
              ...
              <div style={{ display: "flex", gap: 8 }}>
                {[
                  { label: "Inicial", val: 497 },
                  { label: "Pro", val: 997 },
                  { label: "Crecimiento", val: 1497 },
                ].map((p) => (
                  <button
                    key={p.val}
          ...
          >
            ...
            >
              ...
              >
                Valor Mensual de la Automatización
              </div>
              <div
                style={{
              ...
              >
                por mes en ingresos recuperados + tiempo ahorrado
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <div>
                  ...
                  >
                    {roi > 0 ? `${roiMultiple}x ROI` : "Invirtiendo en crecimiento"}
                  </div>
                  <div
                    style={{
                      fontFamily: "'DM Mono', monospace",
            ...
            >
              ...
              {[
                ...
                },
                {
                  ...
                  value: timeSaved,
                  sub: `${hoursSaved} hrs/mes × $${hourlyRate}/hr`,
                  color: "var(--gold)",
                },
                {
                  label: "Costo del plan",
                  value: -plan,
                  sub: `Plan ${plan === 497 ? "Inicial" : plan === 997 ? "Pro" : "Crecimiento"}`,
                  color: "var(--text-dim)",
                },
              ].map((item, i) => (
                <div
            ...
            >
              ...
              >
                Estas son estimaciones conservadoras. La mayoría de los clientes supera estas cifras en los primeros 60 días.
              </p>
              <a
                href={BOOKING_URL}
                target="_blank"
              ...
              >
                Obtener Mi Plan de ROI Personalizado →
              </a>
            </div>
          </motion.div>
        </div>
