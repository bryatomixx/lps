...
// Validate ../../app/api/tickets/list/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/tickets/list">> = Specific
  const handler = {} as typeof import("../../app/api/tickets/list/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
